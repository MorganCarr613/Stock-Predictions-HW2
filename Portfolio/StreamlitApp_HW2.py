...
MODEL_INFO = {
        ...
        "keys": ["ORCL", "NVDA", "DEXCAUS", "DEXUSEU", "SP500", "NASDAQCOM", "DGS10"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["ORCL", "NVDA", "DEXCAUS", "DEXUSEU", "SP500", "NASDAQCOM", "DGS10"]]
}

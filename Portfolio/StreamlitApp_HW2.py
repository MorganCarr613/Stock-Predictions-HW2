...
MODEL_INFO = {
        ...
        "keys": ["PEP", "KDP", "DEXCAUS", "DEXUSEU", "SP500", "NASDAQCOM", "DGS10"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["PEP", "KDP", "DEXCAUS", "DEXUSEU", "SP500", "NASDAQCOM", "DGS10"]]
}
